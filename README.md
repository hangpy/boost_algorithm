...
[좌표평면 상에서의 거리 관련 문제에선 일단 유클리디안 거리를 떠올리자!](./SWEA/SWEA_2117#실수한-부분)

[queue도 사이즈 활용이 가능하다!](./SWEA/SWEA_5653#실수한-부분)

[동시성 우선순위 문제는 말그대로 우선순위대로 연산하는 방법을 찾자](./SWEA/SWEA_5653#실수한-부분)

[재귀호출에서 다음 상태를 매개변수로 넘길 때, 현재 상태를 함부로 갱신하지 말자](./SWEA/SWEA_4013#실수한-부분)

[범위기반 for문을 사용할 때 원본 변경 여부(&)를 반드시 확인하자!](./SWEA/SWEA_2383/#실수한-부분)

[시간의 흐름 제약을 꼼꼼히 확인하자!](./SWEA/SWEA_2383/#실수한-부분)

[분기의 완전성(if, else if, else)을 귀찮더라도 지키자!](./BAEK/BAEK_16236#실수한-부분)

[입력을 받을 때 그대로 대입할 지, 후처리를 해야하는지 꼭 확인하자!](./BAEK/BAEK_16236#실수한-부분)
...
[하나의 그룹으로 묶여있는지는 dfs 한번으로 판별 가능함을 생각하자!](./BAEK/BAEK_17471#실수한-부분)
...
[SWEA 2117. 홈 방범 서비스](./SWEA/SWEA_2117) (논리적으로 BFS이지만 유클리디안 거리를 통해 더 빠르게 계산 가능) 🌟

[BAEK 1039. 교환](BAEK/BAEK_1039) (+백트래킹)

[SWEA 2105. 디저트 카페](./SWEA/SWEA_2105) (+백트레킹, 중복계산 찾아내기, 분할 병합 판별)
...
[BAEK 17471. 게리맨더링](./BAEK/BAEK_17471) 🌟🌟🌟 (묶음 체크)
